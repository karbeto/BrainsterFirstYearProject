        ...
        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <button type="submit" class="w-full p-2 rounded-xl text-white bg-[#8448e5] hover:bg-[#101010] hover:border-[1px] hover:border-[#8448e5]">Log in</button>
                    <p class="text-sm font-light text-gray-500">
                        Don’t have an account yet? <a href="{{ route('signup') }}" class="font-medium text-[#f54646] hover:underline">Sign up</a>
                    </p>
                </form>
            </div>
        </div>
